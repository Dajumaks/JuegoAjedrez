...
package autonoma.JuegoAjedrez.views;
...
public class VentanaEleccionFicha extends javax.swing.JDialog {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        autonoma.JuegoAjedrez.Controlador.Controlador.fichaElegida = "A_alfil";
        autonoma.JuegoAjedrez.Controlador.Controlador.imagenElegida = (ImageIcon) jButton2.getIcon();
        dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        autonoma.JuegoAjedrez.Controlador.Controlador.fichaElegida = "A_reina";
        autonoma.JuegoAjedrez.Controlador.Controlador.imagenElegida = (ImageIcon) jButton1.getIcon();
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        autonoma.JuegoAjedrez.Controlador.Controlador.fichaElegida = "A_caballo";
        autonoma.JuegoAjedrez.Controlador.Controlador.imagenElegida = (ImageIcon) jButton3.getIcon();
        dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        autonoma.JuegoAjedrez.Controlador.Controlador.fichaElegida = "A_torre";
        autonoma.JuegoAjedrez.Controlador.Controlador.imagenElegida = (ImageIcon) jButton4.getIcon();
        dispose();
